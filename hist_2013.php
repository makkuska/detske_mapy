    ...
    <?php include_once("header.html") ?>
      ...
      <div class="hlavni container"> 
        <div class="row container">
          ...
          <p><strong>Celkem bylo hodnoceno v jednotlivých kategoriích:</strong> 
          <ul>
            ...
            <p><strong>Do mezinárodního kola byly vybrány následující práce:</strong>
            <ul>
          ...
          <div id="links container">
            ...
            <div class="row">
              <div class="col-lg-4 col-lg-offset-2">
                ...
                <a href="dist/foto/1-2misto_katA_Daniela_Novakova_4roky.jpg" title="Daniela Nováková, 1.místo, kategorie A" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Daniela Nováková, 1.místo, kategorie A">
                </a>
              </div>
              <div class="col-lg-4">
                <p>1-2.místo <br /><strong>Marek Číhal</strong><br />Příkazy (3 roky)</p>
                <a href="dist/foto/1-2misto_katA_Marek_Číhal.jpg" title="Marek Číhal, 1-2.místo, kategorie A" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Marek Číhal, 1-2.místo, kategorie A">
                </a>
              </div>
            </div>
          </div>
          <div id="links container row">
            <h3 class="page-header">Kategorie B: 6-8 roků</h3>
            <div class="row">
              <div class="col-lg-4">
                <p>1.místo <br /><strong>Jan Poskočil</strong><br />Tovéř (8 roků)</p>
                <a href="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" title="Jan Poskočil, 1. místo, kategorie B" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Jan Poskočil, 1. místo, kategorie B">
                </a>
              </div>
              <div class="col-lg-4">
                <p>2.místo <br /><strong>Patrik Drexler</strong><br />ZŠ a MŠ Dolní Domaslavice (8 roků)</p>
                <a href="dist/foto/2misto_katB_Patrik_Drexler" title="Patrik Drexler, 2.místo, kategorie B" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Patrik Drexler, 2.místo, kategorie B">
                </a>
              </div>
              <div class="col-lg-4">
                <p>3.místo <br /><strong>Laura Pohorelcová</strong><br />ZŠ Staňkova, Pardubice (6 roků)</p>
                <a href="dist/foto/3misto_katB_Laura_Pohorelcová.jpg" title="Laura Pohorelcová, 3.místo, kategorie B" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Laura Pohorelcová, 3.místo, kategorie B">
                </a>
              </div>
            </div>
          </div>
          <div id="links container">
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <a href="dist/foto/1misto_katC_Viktorie_Karla_Wojnarová.jpg" title="Viktorie Karla Wojnarová, 1. místo, kategorie C" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Viktorie Karla Wojnarová, 1. místo, kategorie C">
                </a>
              </div>
              <div class="col-lg-4">
                <p>2.místo <br /><strong>Julie Kroupová</strong><br />ZŠ T.G.Masaryka, Český Krumlov (9.roků)</p>
                <a href="dist/foto/2misto_katC_Julie_Kroupová" title="Julie Kroupová, 2.místo, kategorie C" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Julie Kroupová, 2.místo, kategorie C">
                </a>
              </div>
              <div class="col-lg-4">
                <p>3.místo <br /><strong>Vanessa Marie Wojnarová</strong><br />Zahnašovice (12 roků)</p>
                <a href="dist/foto/3misto_katC_Vanessa_Marie_Wojnarová" title="Vanessa Marie Wojnarová, 3.místo, kategorie C" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Vanessa Marie Wojnarová, 3.místo, kategorie C">
                </a>
              </div>
            </div>
          </div>
          <div id="links container">
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <a href="dist/foto/1misto_katD_Hana_Lamačová" title="Hana Lamačová, 1.místo, kategorie D" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Hana Lamačová, 1.místo, kategorie D">
                </a>
              </div>
              <div class="col-lg-4">
                <p>2.místo <br /><strong>Kateřina Souralová</strong><br />Gymnázium P. Křížkovského, Brno<br /> (13 roků)</p>
                <a href="dist/foto/2misto_katD_Kateřina_Souralová" title="Kateřina Souralová, 2.místo, kategorie D" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Kateřina Souralová, 2.místo, kategorie D">
                </a>
              </div>
              <div class="col-lg-4">
                <p>3.místo <br /><strong>Adriana Smékalová</strong><br />ZŠ a Dětský domov Vídeňská, Brno<br /> (15 roků)</p>
                <a href="dist/foto/3misto_katD_Adriana_Smékalová" title="Adriana Smékalová, 3.místo, kategorie D" data-gallery>
                  <img src="dist/foto/zmensene/1misto_katB_Jan_Poskočil_orez.jpg" alt="Adriana Smékalová, 3.místo, kategorie D">
                </a>
              </div>
            </div>
            </div>
